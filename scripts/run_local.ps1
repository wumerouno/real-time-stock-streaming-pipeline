...
Write-Host "For the full producer + Spark + dashboard demo, run:"
Write-Host "  .\scripts\start_demo.ps1"
...
Write-Host "  docker compose --profile dashboard up --build dashboard"
